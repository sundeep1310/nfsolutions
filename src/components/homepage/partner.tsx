...
export default function Partner() {
  ...
  const cards = [
    {
      ...
      description:
        'With a proven track record of success, we offer the stability and deep industry knowledge that only comes with years of dedicated experience in the EPC sector.',
      image: '/partner1.jpg'
    },
    {
      title: 'Specialized Focus',
      description:
        'We are not generalists. Our sole focus on technical and commercial advisory for the EPC industry ensures you receive the most relevant, impactful, and actionable guidance.',
      image: '/partner2.png'
    },
    {
      title: 'Global Reach, Local Insight',
      description:
        'Our strategic offices in Singapore, India, and UAE provide the on-the-ground support and global perspective essential for navigating international markets successfully.',
      image: '/partner3.png'
    },
    {
      title: 'Digital Solutions',
      description:
        'We leverage data, cloud, and AI to build modern platforms that accelerate growth. Our business-first engineering approach ensures our solutions deliver measurable and scalable results.',
      image: '/partner4.png'
    }
  ];
  ...
  // Using numeric cubic-bezier arrays for ease to satisfy the Transition typing
  ...
  const titleGroup: Variants = {
    ...
    visible: {
      opacity: 1,
      x: 0,
      transition: { duration: 0.7, ease: [0.22, 1, 0.36, 1] } // easeOut-like cubic bezier
    }
  };
  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            <div className="text-white leading-[160%]" style={{ fontSize: 'clamp(14px, 1.305vw, 24px)', fontFamily: 'Instrument Sans, sans-serif' }}>
              <p className="mb-1" style={{ color: '#4F4F4F', fontFamily: 'Instrument Sans, sans-serif' }}>
                <strong style={{ fontFamily: 'Instrument Sans, sans-serif' }}>NF Solutions</strong> combines years of{' '}
                <strong style={{ fontFamily: 'Instrument Sans, sans-serif' }}> specialized EPC market experience</strong> with a forward-thinking global perspective.
                Our integrated technical and commercial support is designed for one purpose: to make your international expansion successful. We don't just advise; we{' '}
                <strong style={{ fontFamily: 'Instrument Sans, sans-serif' }}>build the roadmap for your growth</strong>, incorporating crucial elements like project risk management to ensure success in the world's most demanding industries.
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        {/* Cards Row */}
        <div
          className="flex max-w-[2400px] mx-[25px]"
          style={{
            gap: '16px',
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className={`transition-all duration-[800ms] overflow-hidden ${
                        isExpanded ? 'opacity-100 max-h-40 mb-4' : 'opacity-0 max-h-0 mb-0'
                      }`}
                      style={{ fontFamily: 'Instrument Sans, sans-serif' }}
                    >
                      <p className="text-sm md:text-base leading-relaxed" style={{ color: '#FFFFFF', textAlign: isMobileOrTablet ? 'center' : 'left', fontFamily: 'Instrument Sans, sans-serif' }}>
                        {card.description}
                      </p>
                    </div>
                  </div>
                  ...
                  {!isMobileOrTablet && isLastCard && (
                    <div
                      className={`flex items-center pb-[15px] transition-all duration-[800ms] ${isExpanded ? 'justify-start pl-[15px]' : 'justify-start pl-[15px] pt-[15px]'}`}
                      style={{
