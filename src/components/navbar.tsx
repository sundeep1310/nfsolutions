...
const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['about', 'why', 'ourservices', 'team', 'contact'];
  ...
  return (
    <>
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? 'open' : ''}`}>
        ...
        <a href="#ourservices" onClick={() => handleMobileMenuClick('services')}>
          Our Services
        </a>
        ...
        <div className="nav-container pt-[20px] px-[60px]">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3" style={{ marginLeft: '20px' ,paddingLeft: '12px' }}>
              ...
              <div className="nav-links flex items-center" style={{ gap: 'clamp(24px, 3vw, 48px)' }}>
                ...
                <a href="#ourservices" style={{ color: '#FFFFFF', fontWeight: 400, fontSize: 'clamp(14px, 1.2vw, 16px)', textDecoration: 'none', fontFamily: 'Instrument Sans, sans-serif' }} className="hover:opacity-70 transition-opacity whitespace-nowrap">
                  Our Services
                </a>
